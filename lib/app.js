...
// work capital modification : detect buffers!
function login (label, hostname, port, password, dbIndex, callback) {
  console.log('connecting with buffer detection... ', hostname, port);
  var client = redis.createClient(port, hostname, {'detect_buffers': true});
  client.label = label;
